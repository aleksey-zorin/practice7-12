...
// ============================================
// АННОТАЦИИ SWAGGER ДЛЯ PRODUCTS
// ============================================
...
app.delete("/api/users/:id", authMiddleware, (req, res) => {
    ...
    user.isActive = false;
    res.json({ message: "Пользователь заблокирован", user: { id: user.id, email: user.email, isActive: user.isActive } });
});
